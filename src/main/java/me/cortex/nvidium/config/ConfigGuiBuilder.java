...
public class ConfigGuiBuilder {
        ...
        public static void addNvidiumGui(List<OptionPage> pages) {
                ...
                groups.add(OptionGroup.createBuilder()
                                .add(OptionImpl.createBuilder(boolean.class, store)
                                                ...
                                                .setTooltip(Text.literal(
                                                                "Used to disable Nvidium (DOES NOT SAVE, WILL RE-ENABLE AFTER A RE-LAUNCH)"))
                                                .setControl(TickBoxControl::new)
                                                .setImpact(OptionImpact.HIGH)
                                                .setBinding((opts, value) -> Nvidium.FORCE_DISABLE = value,
                                                                opts -> Nvidium.FORCE_DISABLE)
                        ...
                        groups.add(OptionGroup.createBuilder()
                                        .add(OptionImpl.createBuilder(boolean.class, store)
                                                        .setName(Text.literal(
                                                                        "Nvidium disabled due to shaders being loaded"))
                                                        .setTooltip(Text.literal(
                                                                        "Nvidium disabled due to shaders being loaded"))
                                                        .setControl(TickBoxControl::new)
                ...
                groups.add(OptionGroup.createBuilder()
                                .add(OptionImpl.createBuilder(int.class, store)
                                                ...
                                                .setTooltip(Text.translatable(
                                                                "nvidium.options.region_keep_distance.tooltip"))
                                ...
                                .add(OptionImpl.createBuilder(boolean.class, store)
                                                .setName(Text.translatable(
                                                                "nvidium.options.enable_temporal_coherence.name"))
                                                .setTooltip(Text.translatable(
                                                                "nvidium.options.enable_temporal_coherence.tooltip"))
                                                .setControl(TickBoxControl::new)
                                ...
                                .add(OptionImpl.createBuilder(boolean.class, store)
                                                .setName(Text.translatable(
                                                                "nvidium.options.automatic_memory_limit.name"))
                                                .setTooltip(Text.translatable(
                                                                "nvidium.options.automatic_memory_limit.tooltip"))
                                                .setControl(TickBoxControl::new)
                                                .setImpact(OptionImpact.VARIES)
                                                .setEnabled(Nvidium.IS_ENABLED)
                                ...
                                .add(OptionImpl.createBuilder(int.class, store)
                                                ...
                                                .setControl(option -> new SliderControl(option, 2048, 32768, 512,
                                                                ControlValueFormatter.translateVariable(
                                                                                "nvidium.options.mb")))
                                                .setImpact(OptionImpact.VARIES)
                                ...
                                .add(OptionImpl.createBuilder(TranslucencySortingLevel.class, store)
                                                ...
                                                .setTooltip(Text.translatable(
                                                                "nvidium.options.translucency_sorting.tooltip"))
                                                .setControl(
                                                                opts -> new CyclingControl<>(
                                                                                ...
                                                                                new Text[] {
                                                                                                Text.translatable(
                                                                                                                "nvidium.options.translucency_sorting.none"),
                                                                                                Text.translatable(
                                                                                                                "nvidium.options.translucency_sorting.sections"),
                                                                                                Text.translatable(
                                                                                                                "nvidium.options.translucency_sorting.quads")
                                                                                }))
                                ...
                                .add(OptionImpl.createBuilder(StatisticsLoggingLevel.class, store)
                                                ...
                                                .setTooltip(Text.translatable(
                                                                "nvidium.options.statistics_level.tooltip"))
                                                .setControl(
                                                                opts -> new CyclingControl<>(
                                                                                opts,
                                                                                ...
                                                                                new Text[] {
                                                                                                Text.translatable(
                                                                                                                "nvidium.options.statistics_level.none"),
                                                                                                Text.translatable(
                                                                                                                "nvidium.options.statistics_level.frustum"),
                                                                                                Text.translatable(
                                                                                                                "nvidium.options.statistics_level.regions"),
                                                                                                Text.translatable(
                                                                                                                "nvidium.options.statistics_level.sections"),
                                                                                                Text.translatable(
                                                                                                                "nvidium.options.statistics_level.quads")
                                                                                }))
                ...
                if (Nvidium.IS_COMPATIBLE) {
                        pages.add(new OptionPage(Text.translatable("nvidium.options.pages.nvidium"),
